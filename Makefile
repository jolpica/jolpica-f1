...
2000s-fixture:
	python manage.py dump_object formula_one.sessionentry --query '{"session__race__season__year__gte":2000}' > tests/fixtures/2000s_session_entries.tmp.json
	python manage.py dump_object formula_one.session --query '{"race__season__year__gte":2000}' > tests/fixtures/2000s_sessions.tmp.json
	python manage.py dump_object formula_one.pitstop --query '{"session_entry__session__race__season__year":2014}' > tests/fixtures/2000s_pitstops.tmp.json
	python manage.py dump_object formula_one.lap --query '{"session_entry__session__race__season__year":2013}' > tests/fixtures/2000s_laps.tmp.json
...
legacy-fixture:
	python manage.py dump_object formula_one.sessionentry --query '{"session__race__season__year__in": [1960, 1969, 1975, 1979, 1980, 1985, 1997], "session__type": "R"}' > tests/fixtures/legacy_data.json
