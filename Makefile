...
test-fixture:
	python manage.py dump_object formula_one.sessionentry --query '{"session__race__season__year__gte":2000, "session__race__season__year__lte":2010}' > tests/fixtures/2000s_sessions.json
