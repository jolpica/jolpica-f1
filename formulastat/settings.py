"""Django settings for formulastat project.
...
WSGI_APPLICATION = "formulastat.wsgi.application"


# Database
# https://docs.djangoproject.com/en/4.2/ref/settings/#databases

DATABASES = {"default": env.db("DATABASE_SECRET_URL", default="postgis://postgres:postgres@localhost/formulastat")}
