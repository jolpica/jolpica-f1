        ...
        return (
            ...
            .prefetch_related(
                Prefetch(
                    "teams",
                    Team.objects.filter(
                        team_drivers__round_entries__round__season__year=season_year,
                        team_drivers__round_entries__round__number__lte=race_round,
                    )
                    .annotate(first_team_entry=Min("team_drivers__round_entries__round__number"))
