...
- [F1nally](https://apps.apple.com/us/app/f1nally/id1618275556) – An iPhone app that displays the upcoming F1 schedule, as well as the current championship standings. Not currently open-source, but free, with no ads and no data collection.
