# Generated by Django 4.2.10 on 2024-03-31 11:36
...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("formula_one", "0009_remove_driverchampionship_finish_string_and_more"),
    ]
    ...
    operations = [
       ...
       # Drop extensions enabled by default in devcontainer image to better match production
        migrations.RunSQL(
            sql="DROP EXTENSION IF EXISTS postgis_tiger_geocoder",
            reverse_sql="",
        ),
        migrations.RunSQL(
            sql="DROP EXTENSION IF EXISTS postgis_topology",
            reverse_sql="",
        ),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[
                            ...
                            (
                                2,
                                "Entry must have a classified finish in at least 1 round",
                            ),
                        ]
                    ),
                ),
